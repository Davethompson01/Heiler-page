    ...
    <>
      <div className="">
        ...
        <div className="relative  sm:flex ">
          <div className="absolute  sm:flex top-[-100px] mx-auto left-[5%] right-[5%]">
            <div className="  h-[600px]  rounded-xl py-6 px-4 bg-[#f2fbf6] ">
              <div className="">
                <div className="pb-12">
          ...
          <div className=" shadow-2xl absolute rounded-xl p-4 grid place-content-center top-[520px]  sm:top-[-100px] bg-slate-400 sm:basis-[40%] h-[550px]  left-[5%] right-[5%] ">
