...
const Testimoials = () => {
  ...
  return (
    <>
      <div className=" bg-[#f5fffa] p-2  lg:px-10 shadow-lg">
        <h1 className="text-center font-bold text-[#035930B2]">Testimonials</h1>
        <h1 className="mb-5 text-center font-[700] text-[25px] text-[#00a651]">
          What Our Patients Says About Us
        </h1>

        <div className="grid gap-8 four:grid-cols-2 md:grid-cols-4">
          {maps.map((element, index) => (
            <div key={index} className="bg-white relative p-5 mt-4 rounded-xl">
